<template>
  <div class="p-2">
    ...
    <!-- Form area -->
    <FundModal ref="registerModal" @success="handleSuccess"></FundModal>
  </div>
</template>

<script lang="ts" name="fund-fund" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './Fund.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './Fund.api';
