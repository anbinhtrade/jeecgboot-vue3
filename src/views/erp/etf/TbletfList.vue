<template>
  <div class="p-2">
    ...
    <!-- Form area -->
    <TbletfModal ref="registerModal" @success="handleSuccess"></TbletfModal>
  </div>
</template>

<script lang="ts" name="etf-tbletf" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './Tbletf.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './Tbletf.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import TbletfModal from './components/TbletfModal.vue'
