  ...
  <div>
        ...
        <a-row :gutter="24">
          <a-col :lg="8">
            <a-form-item label="USERNAME">
              <a-input placeholder="Please enter a name fuzzy query" v-model:value="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :lg="8">
            <a-form-item label="AGE">
              <a-input placeholder="Minimum age" type="ge" v-model:value="queryParam.age_begin" style="width: calc(50% - 15px)"></a-input>
              <span>~</span>
              <a-input placeholder="Maximum age" type="le" v-model:value="queryParam.age_end" style="width: calc(50% - 15px)"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :lg="8">
              <a-form-item label="GENDER">
                <JDictSelectTag v-model:value="queryParam.sex" placeholder="Please select a gender" dictCode="sex" />
              </a-form-item>
            </a-col>
            <a-col :lg="8">
              <a-form-item label="Select Users">
                <JDictSelectTag v-model:value="queryParam.id" placeholder="Please select a user" dictCode="demo,name,id" />
              </a-form-item>
            </a-col>
          </template>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" :class="{ 'p-4': customSearch }">
      <template #form-age="{ model, field }">
        <a-input placeholder="Minimum age" type="ge" v-model:value="min" style="width: calc(50% - 15px)" @change="ageChange(model, field)"></a-input>
        <span>~</span>
      ...
      <template #tableTitle>
        ...
        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="openTab">Open the Tab page</a-button>
        <a-button preIcon="ant-design:retweet-outlined" type="primary" @click="customSearch = !customSearch">{{
          customSearch ? 'Form configuration queries' : 'Custom queries'
        }}</a-button>
        <a-button preIcon="ant-design:import-outlined" type="primary" @click="handleImport">Pop-up window import</a-button>
