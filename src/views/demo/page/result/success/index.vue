<template>
  <div class="m-5 result-success">
    <Result
      ...
      sub-title="The submission result page is used to feedback the processing results of a series of operation tasks. If it is only a simple operation, use Message Feedback is sufficient. This text area can display simple supplementary notes, if there is a similar display “单据”的需求，下面这个灰色区域可以呈现比较复杂的内容。"
    >
      <template #extra>
